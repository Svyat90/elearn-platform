...
class HomeController
{
    public function index()
    {
        ...
        return view('home', compact('settings1', 'settings2', 'settings3', 'settings4', 'chart5', 'chart6', 'settings7', 'settings8', 'settings9', 'settings10', 'settings11', 'settings12', 'chart13'));
    }
