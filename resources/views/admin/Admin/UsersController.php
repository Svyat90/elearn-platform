...
class UsersController extends Controller
{
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'country', 'gender', 'userOrders', 'userVideos', 'userLoginLogs', 'userPaymentLogs', 'userArtistPaymentHistories', 'earnFromArtistPaymentHistories', 'userAgentPaymentHistories', 'earnFromAgentPaymentHistories', 'userAgentMeta', 'artistArtistMeta', 'userUserMeta', 'userUserWalletHistories', 'earnFromUserWalletHistories', 'artistArtistEnquiries', 'agentAgentMeta', 'userUserWishlists', 'userUserLikes');
