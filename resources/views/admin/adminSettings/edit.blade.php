    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.admin-settings.update", [$adminSetting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_commission') ? 'is-invalid' : '' }}" type="number" name="user_commission" id="user_commission" value="{{ old('user_commission', $adminSetting->user_commission) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('artist_commission') ? 'is-invalid' : '' }}" type="number" name="artist_commission" id="artist_commission" value="{{ old('artist_commission', $adminSetting->artist_commission) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agent_commission') ? 'is-invalid' : '' }}" type="number" name="agent_commission" id="agent_commission" value="{{ old('agent_commission', $adminSetting->agent_commission) }}" step="1">
