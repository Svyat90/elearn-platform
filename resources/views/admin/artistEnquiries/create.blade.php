...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.artistEnquiry.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.artist-enquiries.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_media_type') ? 'is-invalid' : '' }}" type="text" name="social_media_type" id="social_media_type" value="{{ old('social_media_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_media') ? 'is-invalid' : '' }}" type="text" name="social_media" id="social_media" value="{{ old('social_media', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_media_followrs') ? 'is-invalid' : '' }}" type="number" name="social_media_followrs" id="social_media_followrs" value="{{ old('social_media_followrs', '0') }}" step="1">
