...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.artistMetum.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.artist-meta.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('profile_info') ? 'is-invalid' : '' }}" name="profile_info" id="profile_info">{!! old('profile_info') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('main_catogery') ? 'is-invalid' : '' }}" name="main_catogery_id" id="main_catogery_id">
                    @foreach($main_catogeries as $id => $main_catogery)
                        <option value="{{ $id }}" {{ old('main_catogery_id') == $id ? 'selected' : '' }}>{{ $main_catogery }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('artist_fee') ? 'is-invalid' : '' }}" type="number" name="artist_fee" id="artist_fee" value="{{ old('artist_fee', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('artist_commission') ? 'is-invalid' : '' }}" type="number" name="artist_commission" id="artist_commission" value="{{ old('artist_commission', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_commission') ? 'is-invalid' : '' }}" type="number" name="company_commission" id="company_commission" value="{{ old('company_commission', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_status_email') ? 'is-invalid' : '' }}" type="text" name="order_status_email" id="order_status_email" value="{{ old('order_status_email', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url_name') ? 'is-invalid' : '' }}" type="text" name="url_name" id="url_name" value="{{ old('url_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_instagram') ? 'is-invalid' : '' }}" type="text" name="social_instagram" id="social_instagram" value="{{ old('social_instagram', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_facebook') ? 'is-invalid' : '' }}" type="text" name="social_facebook" id="social_facebook" value="{{ old('social_facebook', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_youtube') ? 'is-invalid' : '' }}" type="text" name="social_youtube" id="social_youtube" value="{{ old('social_youtube', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_tiktok') ? 'is-invalid' : '' }}" type="text" name="social_tiktok" id="social_tiktok" value="{{ old('social_tiktok', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_snapchat') ? 'is-invalid' : '' }}" type="text" name="social_snapchat" id="social_snapchat" value="{{ old('social_snapchat', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_twitter') ? 'is-invalid' : '' }}" type="text" name="social_twitter" id="social_twitter" value="{{ old('social_twitter', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_twitch') ? 'is-invalid' : '' }}" type="text" name="social_twitch" id="social_twitch" value="{{ old('social_twitch', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_linkedin') ? 'is-invalid' : '' }}" type="text" name="social_linkedin" id="social_linkedin" value="{{ old('social_linkedin', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('artist_status') ? 'is-invalid' : '' }}" name="artist_status" id="artist_status">
                    ...
                    @foreach(App\ArtistMetum::ARTIST_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('artist_status', '1') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
