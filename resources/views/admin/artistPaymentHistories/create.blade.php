...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.artistPaymentHistory.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.artist-payment-histories.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('any_fees') ? 'is-invalid' : '' }}" type="number" name="any_fees" id="any_fees" value="{{ old('any_fees', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('any_charges') ? 'is-invalid' : '' }}" type="number" name="any_charges" id="any_charges" value="{{ old('any_charges', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('final_amount') ? 'is-invalid' : '' }}" type="number" name="final_amount" id="final_amount" value="{{ old('final_amount', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('txn_for') ? 'is-invalid' : '' }}" name="txn_for" id="txn_for">
                    ...
                    @foreach(App\ArtistPaymentHistory::TXN_FOR_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('txn_for', '1') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('proccesed_by') ? 'is-invalid' : '' }}" type="text" name="proccesed_by" id="proccesed_by" value="{{ old('proccesed_by', '') }}">
