            ...
            <form method="POST" action="{{ route("admin.courses.update", [$course->id]) }}"
                    ...
                    <div class="form-group col-md-4 col-sm-6 col-xs-12">
                        ...
                        <select class="form-control select2 {{ $errors->has('access') ? 'is-invalid' : '' }}"
                            ...
                            @foreach($accessTypes as $access)
                                <option
                                    value="{{ $access }}" {{ $access }}
                                " {{ old('access', $course->access) === $access ? 'selected' : '' }}
                                >{{ $access }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}"
                              name="description" id="description">{!! old('description', $course->description) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div>{!! sprintf('<img src="%s" style="max-width: 200px;" />', storageUrl($course->image_path)) !!}</div>
