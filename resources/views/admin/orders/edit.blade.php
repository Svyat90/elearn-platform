    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('message') ? 'is-invalid' : '' }}" type="text" name="message" id="message" value="{{ old('message', $order->message) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('language') ? 'is-invalid' : '' }}" name="language_id" id="language_id">
                    @foreach($languages as $id => $language)
                        <option value="{{ $id }}" {{ ($order->language ? $order->language->id : old('language_id')) == $id ? 'selected' : '' }}>{{ $language }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_to') ? 'is-invalid' : '' }}" type="text" name="video_to" id="video_to" value="{{ old('video_to', $order->video_to) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('to_gender') ? 'is-invalid' : '' }}" type="text" name="to_gender" id="to_gender" value="{{ old('to_gender', $order->to_gender) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_name') ? 'is-invalid' : '' }}" type="text" name="customer_name" id="customer_name" value="{{ old('customer_name', $order->customer_name) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('occasion_type') ? 'is-invalid' : '' }}" name="occasion_type_id" id="occasion_type_id">
                    @foreach($occasion_types as $id => $occasion_type)
                        <option value="{{ $id }}" {{ ($order->occasion_type ? $order->occasion_type->id : old('occasion_type_id')) == $id ? 'selected' : '' }}>{{ $occasion_type }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_email') ? 'is-invalid' : '' }}" type="text" name="delivery_email" id="delivery_email" value="{{ old('delivery_email', $order->delivery_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_phone') ? 'is-invalid' : '' }}" type="text" name="delivery_phone" id="delivery_phone" value="{{ old('delivery_phone', $order->delivery_phone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('promo_code') ? 'is-invalid' : '' }}" type="text" name="promo_code" id="promo_code" value="{{ old('promo_code', $order->promo_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('promo_discount') ? 'is-invalid' : '' }}" type="number" name="promo_discount" id="promo_discount" value="{{ old('promo_discount', $order->promo_discount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('booking_amount') ? 'is-invalid' : '' }}" type="number" name="booking_amount" id="booking_amount" value="{{ old('booking_amount', $order->booking_amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('booking_datetime') ? 'is-invalid' : '' }}" type="text" name="booking_datetime" id="booking_datetime" value="{{ old('booking_datetime', $order->booking_datetime) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('payment_by') ? 'is-invalid' : '' }}" name="payment_by" id="payment_by">
                    ...
                    @foreach(App\Order::PAYMENT_BY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('payment_by', $order->payment_by) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('artist') ? 'is-invalid' : '' }}" name="artist_id" id="artist_id">
                    @foreach($artists as $id => $artist)
                        <option value="{{ $id }}" {{ ($order->artist ? $order->artist->id : old('artist_id')) == $id ? 'selected' : '' }}>{{ $artist }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order') ? 'is-invalid' : '' }}" type="number" name="order" id="order" value="{{ old('order', $order->order) }}" step="1">
                @if($errors->has('order'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_pin') ? 'is-invalid' : '' }}" type="number" name="order_pin" id="order_pin" value="{{ old('order_pin', $order->order_pin) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_note') ? 'is-invalid' : '' }}" type="text" name="order_note" id="order_note" value="{{ old('order_note', $order->order_note) }}">
