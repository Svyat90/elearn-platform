...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.pageSeo.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.page-seos.update", [$pageSeo->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="page_url">{{ trans('cruds.pageSeo.fields.page_url') }}</label>
                <input class="form-control {{ $errors->has('page_url') ? 'is-invalid' : '' }}" type="text" name="page_url" id="page_url" value="{{ old('page_url', $pageSeo->page_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $pageSeo->meta_title) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" name="meta_description" id="meta_description">{!! old('meta_description', $pageSeo->meta_description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('meta_keywords') ? 'is-invalid' : '' }}" name="meta_keywords" id="meta_keywords">{!! old('meta_keywords', $pageSeo->meta_keywords) !!}</textarea>
