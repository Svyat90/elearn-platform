                            ...
                            <td>
                                @can('sub_category_show')
                                    <a class="btn btn-xs btn-primary"
                                       href="{{ route('admin.sub_categories.show', $subCategory->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                                ...
                                @can('sub_category_edit')
                                    <a class="btn btn-xs btn-info"
                                       href="{{ route('admin.sub_categories.edit', $subCategory->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('sub_category_delete')
                                    <form action="{{ route('admin.sub_categories.destroy', $subCategory->id) }}"
