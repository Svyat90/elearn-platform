    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-accessUsers">
                    <thead>
                    <tr>
                        <th width="10">
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            $('.datatable-accessUsers:not(.ajaxTable)').DataTable({buttons: dtButtons})
