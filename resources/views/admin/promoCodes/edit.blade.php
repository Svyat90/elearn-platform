    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.promo-codes.update", [$promoCode->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('promo_code') ? 'is-invalid' : '' }}" type="text" name="promo_code" id="promo_code" value="{{ old('promo_code', $promoCode->promo_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}" type="number" name="discount" id="discount" value="{{ old('discount', $promoCode->discount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minimum_order_value') ? 'is-invalid' : '' }}" type="number" name="minimum_order_value" id="minimum_order_value" value="{{ old('minimum_order_value', $promoCode->minimum_order_value) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $promoCode->start_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $promoCode->end_date) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('promotion_info') ? 'is-invalid' : '' }}" name="promotion_info" id="promotion_info">{!! old('promotion_info', $promoCode->promotion_info) !!}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\PromoCode::STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $promoCode->status) === $key ? 'checked' : '' }}>
