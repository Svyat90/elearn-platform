    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-userPaymentLogs">
                    <thead>
                        <tr>
                            <th width="10">
...
<script>
  ...
  $('.datatable-userPaymentLogs:not(.ajaxTable)').DataTable({ buttons: dtButtons })
