    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-userUserWalletHistories">
                    <thead>
                        <tr>
                            <th width="10">
...
@endcan
  ...
  $('.datatable-userUserWalletHistories:not(.ajaxTable)').DataTable({ buttons: dtButtons })
