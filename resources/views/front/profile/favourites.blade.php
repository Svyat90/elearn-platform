                        ...
                        <div class="grid">
                            ...
                            <div class="row">
                                @if(count($documents) > 0)
                                    ...
                                    @endforeach
                                @else
                                    <div class="" style="margin-left: 20px;">{{ __('profile.you_dont_have_any_favorite_documents') }}</div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="grid">
                            ...
                            <div class="row">
                                @if(count($courses) > 0)
                                    ...
                                    @endforeach
                                @else
                                    <div class="" style="margin-left: 20px;">{{ __('profile.you_dont_have_any_favorite_courses') }}</div>
                                @endif
                            </div>
                        </div>
