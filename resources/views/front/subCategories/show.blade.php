...
@section('content')
    <main>
        ...
        @include('front.partials.breadcrumbs', ['breadcrumbs' => [
            ...
            ['name' => $subCategory->{localeAppColumn('name')}],
        ]])

        <section class="container white">
            <div class="category-top">
                <img src="{{ categoryImagePath($subCategory->parent->id) }}" alt="">
                <div class="title-section">{{ $subCategory->{localeAppColumn('name')} }}</div>
            </div>
        </section>
        ...
        <section class="container category-filter white">
            <div class="filter">
                <div class="row">
                    <form name="document_filters" action="{{ route('sub-categories.show', $subCategory->id) }}" method="get">
